...
public class ControlPanel extends javax.swing.JPanel {
    ...
    private Runnable pauseButtonAction = () -> {
    };
    private Runnable nextButtonAction = () -> {
    };
    private Runnable prevButtonAction = () -> {
    };
    private Runnable fullscreenButtonAction = () -> {
    };
    ...
    public void setDurationOptions(String[] durationOptions) {
        this.durationOptions = durationOptions;
        durrationsDropDown.setModel(new DefaultComboBoxModel<>(durationOptions));
    }

    public void setFullscreenButtonAction(Runnable fullscreenButtonAction) {
        this.fullscreenButtonAction = fullscreenButtonAction;
    }

    public void setSaveButtonAction(Runnable saveButtonAction) {
        this.saveButtonAction = saveButtonAction;
    }

    public void setLoadButtonAction(Runnable loadButtonAction) {
        this.loadButtonAction = loadButtonAction;
    }

    public void setPlayButtonAction(Runnable playButtonAction) {
        this.playButtonAction = playButtonAction;
    }

    public void setPauseButtonAction(Runnable pauseButtonAction) {
        this.pauseButtonAction = pauseButtonAction;
    }

    public void setNextButtonAction(Runnable nextButtonAction) {
        this.nextButtonAction = nextButtonAction;
    }

    public void setPrevButtonAction(Runnable prevButtonAction) {
...
//        durrationsDropDown.setModel(new );
    ...
    private void initComponents() {
        ...
        durrationsDropDown.setModel(durrationsDropDown.getModel());
    ...
    private void durrationsDropDownActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_durrationsDropDownActionPerformed
        ...
        pickDurationOptionAction.accept(durrationsDropDown.getSelectedIndex());
    ...
    private void loadButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_loadButtonActionPerformed
        // TODO add your handling code here:
        loadButtonAction.run();
    }//GEN-LAST:event_loadButtonActionPerformed

    private void playButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_playButtonActionPerformed
        // TODO add your handling code here:
        if (playButton.getText().contains("⯈")) {
            playButtonAction.run();
            playButton.setText("⏸");
        } else {
            pauseButtonAction.run();
            playButton.setText("⯈");
        }
